 ...
 * ```
 */
export declare class Entity<TKnownComponents extends Component = any> implements OnInitialize, OnPreUpdate, OnPostUpdate {
    private static _ID;
    /**
    ...
    private _instanceOfComponentCacheDirty;
    private _instanceOfComponentCache;
